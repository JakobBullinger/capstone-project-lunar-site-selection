...
def update_figure(temp_min, temp_max, temp_avg):
    ...
    lunar_temp_data_analysed['feasibility_score'] = 1/3 * (lunar_temp_data_analysed['       tbol',  'min'] - temp_min) -  1/3 * (temp_max -lunar_temp_data_analysed['       tbol',  'max'] - temp_max) - 1/3 * (np.sqrt(((temp_avg - (temp_avg - lunar_temp_data_analysed['       tbol',  'mean'])) ** 2)))
